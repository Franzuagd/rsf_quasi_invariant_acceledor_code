...
def main():
	...
	d = 1
	n = 2  #Fixed for now!
	a_box = np.array([3e-2, 5e-3, 2.5e-3, 0.8e-3, 0.8e-3], dtype=float)
	H_pol = (
...
#		plt.plot(st,dispt,label='$100*dD/ds$',linewidth=3.0,color='yellow')
	...
	solution, fobj, ga_instance = optimize(v0,num_generations=200,sol_per_pop=40,num_parents_mating=4,save_csv=True,csv_name="resultados.csv",fobj_csv_name="f_obj_dinamica.csv",opa_txt_name="bloque_opa_final.txt",reset_saved_files=True)
	testing(solution)
	#print("Fobj:")
	#print(fobj)
