...
def invariant(tnn, tnq, Sx, Sy, tol=1e-6):
    ...
    return nhx, nhy, err_x, err_y, norm_Ux_G, norm_Uy_G, rel_err_x, rel_err_y
...
def objfunc(v, print_table=False, save_csv=False):
    ...
    nhx, nhy, err_x, err_y,norm_Ux_G,norm_Uy_G, rel_err_x, rel_err_y= invariant(tnn, tnq, Sx, Sy, tol=1e-6)
